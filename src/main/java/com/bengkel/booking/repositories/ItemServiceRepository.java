...
public class ItemServiceRepository {
	...
	public static List<ItemService> getAllItemService() {
		...
		listItemService = Arrays.asList(itemService1, itemService2, itemService3, itemService4, itemService5,
				itemService6, itemService7, itemService8, itemService9, itemService10);
